...
%         model.umax = [ 50;  50];
    ...
    case '10'
        ...
        xmin    = [-inf,-inf,-inf,    -inf, -pi/4, -inf,     -pi/4, -3.1,     -3*pi/4, 0.1  ];
        xmax    = [ inf, inf, inf,     inf,  pi/4,  inf,     3*pi/4, -0.1,      pi/4, 3.1];

        model.xmin   =  [xmin, -inf,-inf,-inf,   -inf,-inf,-inf,    -10, -100, -10, -100]';
        model.xmax   =  [xmax,  inf, inf, inf,    inf, inf, inf,     10,  100,  10,  100]';

        model.umin = [-10; -100; -10; -100];
        model.umax = [ 10;  100;  10;  100];
